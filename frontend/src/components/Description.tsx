        ...
        <div className="flex flex-col gap-5 md:gap-14 md:flex-row items-center ">
            ...
            <div className="">
                ...
                <p  className="text-gray-600">
                    Simply type in a text prompt, and our cutting-edge AI will generate high-quality images in seconds. From products visuals to character designs and portraits, even concepts that don't yet exists can be visualized effortlessly. Powered by advanced AI technology, the creative possibilites are limitless!
                </p>
            </div>
        </div>
    </motion.div>
