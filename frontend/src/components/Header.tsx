...
const Header = () => {
  ...
  return (
   ...
   transition={{duration:0.8,delay:0.2}}
        ...
        <motion.button className="sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2.5 flex justify-center items-center gap-2 rounded-full cursor-pointer"
        ...
        >Generate Images
            <motion.img src={assets.star_group} alt="" className="h-6" />
        </motion.button>

        <motion.div className="flex items-center flex-wrap justify-center mt-16 gap-3"
        ...
        >
            ...
            <motion.img src={index % 2 === 0 ? assets.sample_img_2 : assets.sample_img_1} alt="" key={index} width={70} className="rounded hover:scale-105 transition-all duration-300 cursor-pointer max-sm:w-10"
